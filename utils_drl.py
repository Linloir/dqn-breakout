...
class Agent(object):
    ...
    def learn(self, memory: ReplayMemory, batch_size: int) -> float:
        ...
        expected = (self.__gamma * values_next.unsqueeze(1)) * (1. - done_batch) + reward_batch # Expected value of Q(s, a) which should be equal to gamma * max_a Q(s', a) + r
        loss = F.smooth_l1_loss(values, expected)                            # Calculate the loss between the expected value and the actual value
